    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="flex justify-center mt-4">
          <a href="https://github.com/sumanthudupi" target="_blank" rel="noopener noreferrer" className="text-white mx-4 social-icon">
          ...
          <a href="https://www.linkedin.com/in/sumanth-udupi/" target="_blank" rel="noopener noreferrer" className="text-white mx-4 social-icon">
